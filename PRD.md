...
Aliya 是一个聚焦于“陪伴”而非“生产力”的 AI 智能体。她基于复古未来主义（Retro-futurism）的审美设计，底层依托于状态机与长上下文工程（Context Engineering）。
...
4. **外部拓扑 (Take-ism/拿来主义)**：全面拥抱 Model Context Protocol (MCP)，以外挂形式接入 1-2 个基础感知工具（如：本地时间/天气获取）。
